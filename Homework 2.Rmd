...
name_data = name_data %>% mutate(childs_first_name = tolower(childs_first_name)) 
name_data = distinct(name_data) 
name_data = name_data %>% group_by(year_of_birth, gender, ethnicity, childs_first_name, rank) %>% summarize(count = sum(count)) %>% 
...
olivia_pop_over_time = spread(olivia_name, key = 'year_of_birth', value = 'rank', fill = 0) %>% group_by(ethnicity) %>% summarize(`2011` = sum(`2011`), `2012` = sum(`2012`), `2013` = sum(`2013`), `2014` = sum(`2014`), `2015` = sum(`2015`), `2016` = sum(`2016`)) 

olivia_name_table = knitr::kable(olivia_pop_over_time) 

# Jayden name table #

jayden_name = name_data %>% filter(childs_first_name == 'jayden') 

jayden_pop_over_time = spread(jayden_name, key = 'year_of_birth', value = 'rank', fill = 0) %>% group_by(ethnicity) %>% summarize(`2011` = sum(`2011`), `2012` = sum(`2012`), `2013` = sum(`2013`), `2014` = sum(`2014`), `2015` = sum(`2015`), `2016` = sum(`2016`))%>% print()
